...
**Pro-tip**: to find less tourist-y places, pick the type of restaurant/food you want (e.g. yakitori), get the japanese translation (e.g. yakitori = 焼き鳥), and search _that_ in Google Maps. Restaurants with "yakitori" in their name have Westernized their names for Google for better tourist SEO (which maybe doesn't actually signal anything in regards to quality though, idk).

To see more local ratings and reviews, try [Tabelog](https://tabelog.com/en/tokyo/) (though FYI, at a glance it looks like Japanese people are rate more harshly on average). Tabelog also has better details on what phone number to call to make reservations.
...
This used to be where they held live tuna auctions every morning around 3 AM–those have since moved to [Toyosu Fish Market](https://www.japan-guide.com/e/e3013_market.html), but the restaurants and shops that buy and serve the fish are still here. 
...
* Matcha or Hojicha latte at [Matcha Stand Maruni](https://goo.gl/maps/PK3nY5LwBW1KZMRy6) (opens 9AM, there's usually a line)

Then line up for an early lunch. I'd recommend lining up at these spots, 45 mins to 1h before they open:

* [Seagen](https://goo.gl/maps/58Go9LhgKPUYy8Rj7) (opens 10AM) - tuna
* [Sushikuni](https://goo.gl/maps/HGArGtFPYaeUQK22A) (opens 10AM) - uni, cash only
* [Yaku Uo Ishikawa](https://goo.gl/maps/ErkmWmMv666Enu2y7) (opens 11AM) - tuna, raw and grilled
...
* **[Tsuta](https://www.thewholeworldisaplayground.com/how-to-eat-tsuta-tokyo-michelin-star-ramen/) (Sugamo):** Michelin-star soba restaurant; very very good, worth the trek (and absolutely not like any of the global expansion locations, like in SF which is awful). Vegetarian-friendly (I think). To eat here, you need to first buy a ticket to secure the time slot of your seating (first-come first-serve, for 11-12, 12-1, or 1-2). I’d recommend buying a ticket around 8 AM for an 11 AM seating. Order by vending machine (cash).
* **[Ramen nagi](https://goo.gl/maps/RZdigPAMRGkPk8iP6) (Shinjuku):** Get some rare Niboshi Ramen (anchovy-based broth), though not worth lining up more than 30 mins for IMO. Order by vending machine (cash).
...
* **[Gyukatsu Motomura](https://www.google.com/maps/search/Gyukatsu+Motomura/@35.6876308,139.6918227,15z/data=!3m1!4b1?entry=ttu) (chain):** Beef tonkatsu restaurant where you sear off the slices of your cutlet on your own personal hot stone grill. We went to the [Shinjuku Minamiguchi location](https://goo.gl/maps/J1MuZAU2LioESVGL9) which was great, but many other locations across Tokyo are well rated too. Can be like a 1h wait so I'd recommend going before they open or at an off-hour like 3 PM.
...
* **[Beauty Style Salon](https://beautystyle.co.jp/) ([Shimomeguro](https://goo.gl/maps/JU5dojY2DxrNSLqr6))** is where I did mine
    * 1h combined session for back-to-back analyses for me and my friend cost ¥19,800 total ~= ~$75 USD per person
    * To book, [email the salon](https://beautystyle.co.jp/contact/) in English for availability, and ask for Emi, she's great!
    * I was able to book just a couple weeks in advance
* **[TATSUMI](https://bestcolors4you.com/englishmenu/) (Shinjuku 1 Chome)** is another popular salon that offers service in English, that I found from a random reddit comment
    * 1.5h personal colour analysis costs ¥16,000 ~= $110 USD
    * [The full service](https://bestcolors4you.com/menuforwomen/) 3h session including a colour diagnosis, face+skeletal diagnosis, and makeup tips costs ¥30,000 ~= $210 USD
...
Part of this was a superb (for me but not for my wallet) [Airbnb Experience](https://www.airbnb.com/experiences/679792) we booked with local fashion industry expert Keisuke-san, who took us on a shopping trip through Omotesando and Ura-Hara. Not only did he show us the low-key high quality brands, but he also took into account our preferences and helped us with styling tips, sizing, and translating with shopkeepers. Would recommend!
